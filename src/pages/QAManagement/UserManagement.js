...
import { Row, Col, Container, Card, CardBody, CardHeader, Modal, ModalHeader, ModalBody, ModalFooter, Button, FormGroup,Label,Input } from 'reactstrap';
                ...
                <ModalBody>
                    ...
                    onSubmit={(values) => {
                      if (isEditMode) {
                        ...
                        console.log('edited user.id:', editedUser.id, 'editedData:', updatedUser);
                ...
                >
                  ...
                  <ErrorMessage name="username" component="div" className="invalid-feedback" />
                    ...
                    <FormGroup>
                        ...
                        <Field type="email" name="email" id="email" placeholder="Enter your email address" className={`form-control ${
